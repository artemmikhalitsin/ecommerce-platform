...
var DesktopsTDG = function () {
    function DesktopsTDG() {
        _classCallCheck(this, DesktopsTDG);
    }

    _createClass(DesktopsTDG, [{
        key: 'add',
         ...
         */
        value: function add(compId, dimensionsId, desktop) {
        ...
        key: 'update',
        value: function update(compId, dimensionsId, desktop) {

...
// console.log(`User fetched by hello@hello.ca and password
//   hello(should be just amanda): ${JSON.stringify(hello)}`);
//
// let wrong = imap.getByEmailAndPassword('hello@hello.ca', 'goodbye');
// console.log(`User fetched by hello@hello.ca and password goodbye
//   (should be no results): ${JSON.stringify(wrong)}`);
//
//
